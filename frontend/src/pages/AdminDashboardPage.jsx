      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col gap-6 sm:gap-8">
        ...
        <section className="grid gap-4 md:grid-cols-2">
          ...
          <button
            ...
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border border-[oklch(0.42_0.14_17_/_0.3)] px-4 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-white shadow-[var(--shadow-wine)] transition-transform hover:scale-[1.02] active:scale-[0.98] sm:h-12 sm:px-5 sm:tracking-widest"
          ...
          <button
            ...
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg px-4 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-white shadow-[var(--shadow-wine)] transition-transform hover:scale-[1.02] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 sm:h-12 sm:px-5 sm:tracking-widest"
